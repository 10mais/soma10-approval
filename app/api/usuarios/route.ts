...
export async function POST(req: NextRequest) {
  ...
  const { nome, email, senha, role, cargo, funcaoVendas, permissoes, clienteId, custoHora, salarioFixo, valorPorProjeto, qtdProjetos } = await req.json()
...
export async function PUT(req: NextRequest) {
  ...
  const { email, nome, role, novaSenha, cargo, funcaoVendas, permissoes, foto, clienteId, custoHora, salarioFixo, valorPorProjeto, qtdProjetos } = await req.json()
